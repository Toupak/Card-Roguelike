...
namespace Combat.Spells.Data.Guard
{
    public class GuardTaunt : SpellController
    {
        ...
        {
            if (dealDamageGa.target == cardController && cardController.cardStatus.IsStatusApplied(StatusType.Taunt) && dealDamageGa.attacker != null && dealDamageGa.attacker.cardStatus.IsStatusApplied(StatusType.Vengeance))
            {
