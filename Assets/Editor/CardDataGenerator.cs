...
namespace Editor
{
    public abstract class CardDataGenerator
    {
        ...
        public static void GenerateCards()
        {
            ...
            string[] guids = AssetDatabase.FindAssets("t:Texture2D", new[] { "Assets/Cards/Artworks" });
                ...
                foreach (var obj in assets)
                {
                    if (obj is Sprite sprite)
                    {
                        ...
                        if (card == null)
                        {
                            ...
                            so.FindProperty("cardName").stringValue = sprite.name;
                            so.FindProperty("artwork").objectReferenceValue = sprite;
