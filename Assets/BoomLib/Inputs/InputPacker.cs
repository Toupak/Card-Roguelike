...
namespace BoomLib.Inputs
{
    ...
    /// <summary>
    /// 
    /// Hello ! I am an Input Package, my job is hold the player inputs for the current frame.
    ///
    /// I also know what is the last type of input used, keyboard and mouse or Gamepad.
    ///
    /// You should implement your own shortHands using the EXAMPLES below
    /// 
    /// </summary>
    public class InputPackage
    {
        ...
        // EXAMPLES : shortHands specific to the current game, can handle gamepad/keyboard bindings
    ...
    /// <summary>
    /// 
    /// Hello ! I am the Input Packer, my job is to gather player inputs into Input Packages.
    /// I am not a monoBehaviour so you need to have a reference on me somewhere.
    ///
    /// I also know when the player changes their type of input, keyboard and mouse or Gamepad.
    /// 
    /// </summary>
    public class InputPacker
    {
        ...
        /// <summary>
        /// Call this method to reset all inputs buffers.
        /// An example would be when going in and out of the pause menu to prevent unintended inputs. 
        /// </summary>
        ...
        /// <summary>
        /// Call this method to check all inputs for this frame and pack them in an InputPackage.
        /// Should only be called once per frame.
        /// </summary>
        /// <returns>
        /// An InputPackage containing all inputs for this frame.
        /// </returns>
        public InputPackage ComputeInputPackage()
        {
            ...
            inputs.anyKey = wasGamepadUsed || wasKeyboardUsed;
